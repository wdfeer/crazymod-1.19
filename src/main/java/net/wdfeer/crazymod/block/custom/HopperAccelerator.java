...
public class HopperAccelerator extends ModBlockWithEntity {
    public HopperAccelerator() {
    ...
    public BlockEntityType<HopperAcceleratorEntity> getBlockEntityType() {
        return ModBlockEntityTypes.HOPPER_ACCELERATOR;
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, getBlockEntityType(), HopperAcceleratorEntity::tick);
    }
}
