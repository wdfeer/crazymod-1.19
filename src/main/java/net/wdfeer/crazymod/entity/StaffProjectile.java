...
public abstract class StaffProjectile extends ProjectileEntity {
    public <T extends StaffProjectile> StaffProjectile(EntityType<T> type, LivingEntity owner, World world) {
        super(type, world);
        this.setOwner(owner);
    }
    public <T extends StaffProjectile> StaffProjectile(EntityType<T> type, World world) {
        super(type, world);
    }
    public abstract float getDamage();
    public abstract int getExtraTicks();
    public abstract void visualTick();
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        entity.damage(DamageSource.thrownProjectile(this, this.getOwner()), getDamage());
    ...
    public void tick() {
        super.tick();
        for (int i = 0; i < 1 + getExtraTicks(); i++) {
